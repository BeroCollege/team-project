...
function fetchGoals() {
  const goalCategories = {
      "goals-doing": [
          { name: "Cooking", image: "cooking.jpeg", detailsPage: "goal-details.html" },
          { name: "Learning Spanish", image: "learn_spanish.jpeg", detailsPage: "goal-details.html" }
      ],
      "goals-did": [
          { name: "Finished a Book", image: "book.jpeg", detailsPage: "goal-details.html" },
          { name: "Completed Marathon", image: "marathon.jpeg", detailsPage: "goal-details.html" }
      ],
      "goals-not-started": [
          { name: "Learn Guitar", image: "guitar.jpeg", detailsPage: "goal-details.html" },
          { name: "Take Art Classes", image: "art_class.jpeg", detailsPage: "goal-details.html" }
      ],
      "goals-didnt-do": [
          { name: "Skydiving", image: "sky_diving.jpeg", detailsPage: "goal-details.html" },
          { name: "Start a Podcast", image: "podcast.jpeg", detailsPage: "goal-details.html" }
      ]
  };
  ...
  goals.forEach(goal => {
      ...
      goalElement.innerHTML = `
          ...
          <div class="progress-container">
              <p>Progress</p>
              <div class="progress">
                  <div class="progress-bar ${savedProgress === 100 ? 'green-bar' : 'yellow-bar'}"
